...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invoice_invoice', (
            ...
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar_event.Reservation'])),
            ('invoice_no', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('html', self.gf('django.db.models.fields.TextField')(max_length=64000, blank=True)),
    ...
    models = {
        ...
        'invoice.invoice': {
            'Meta': {'ordering': "('-created', 'invoice_no')", 'object_name': 'Invoice'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'html': ('django.db.models.fields.TextField', [], {'max_length': '64000', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_no': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'reservation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['calendar_event.Reservation']"})
        },
