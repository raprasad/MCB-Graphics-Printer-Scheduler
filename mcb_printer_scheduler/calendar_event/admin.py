...
class ReservationAdmin(admin.ModelAdmin):
    ...
    list_filter = ('is_visible', 'is_cancelled', 'include_poster_tube', 'user',)
    search_fields = ( 'display_name', 'poster_tube_details', 'user__last_name', 'user__first_name', 'lab', 'billing_code')
