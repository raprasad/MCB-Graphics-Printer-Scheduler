...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Status'
        db.create_table('cal_event_status', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('hex_color', self.gf('django.db.models.fields.CharField')(max_length=8, blank=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=99)),
        ))
        db.send_create_signal('calendar_event', ['Status'])
        ...
        db.create_table('cal_event', (
            ...
            ('is_timeslot_free', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('start_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('subclass_name', self.gf('django.db.models.fields.CharField')(max_length=70, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar_event.Status'])),
        ))
        db.send_create_signal('calendar_event', ['CalendarEvent'])

        # Adding model 'Reservation'
        db.create_table('cal_event_reservation', (
            ('calendarevent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['calendar_event.CalendarEvent'], unique=True, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar_user.CalendarUser'])),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('lab_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('billing_code', self.gf('django.db.models.fields.CharField')(max_length=39, blank=True)),
            ...
            ('include_poster_tube', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('poster_tube_details', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('print_media', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media_type.PrintMediaType'], null=True, blank=True)),
        ))
        db.send_create_signal('calendar_event', ['Reservation'])

        # Adding model 'CalendarMessage'
        db.create_table('cal_event_msg', (
            ('calendarevent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['calendar_event.CalendarEvent'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('calendar_event', ['CalendarMessage'])

        # Adding model 'CalendarFullDayMessageGroup'
        db.create_table('cal_event_msg_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('calendar_event', ['CalendarFullDayMessageGroup'])

        # Adding model 'CalendarFullDayMessage'
        db.create_table('cal_event_day_msg', (
            ('calendarevent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['calendar_event.CalendarEvent'], unique=True, primary_key=True)),
            ('message_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar_event.CalendarFullDayMessageGroup'])),
        ))
        db.send_create_signal('calendar_event', ['CalendarFullDayMessage'])

        # Adding model 'ScheduledBannerMessage'
        db.create_table('cal_event_banner_msg', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('banner_message', self.gf('django.db.models.fields.TextField')()),
            ('id_hash', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('start_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_datetime', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('calendar_event', ['ScheduledBannerMessage'])


    def backwards(self, orm):
        # Deleting model 'Status'
        db.delete_table('cal_event_status')

        # Deleting model 'CalendarEvent'
        db.delete_table('cal_event')

        # Deleting model 'Reservation'
        db.delete_table('cal_event_reservation')

        # Deleting model 'CalendarMessage'
        db.delete_table('cal_event_msg')

        # Deleting model 'CalendarFullDayMessageGroup'
        db.delete_table('cal_event_msg_group')

        # Deleting model 'CalendarFullDayMessage'
        db.delete_table('cal_event_day_msg')

        # Deleting model 'ScheduledBannerMessage'
        db.delete_table('cal_event_banner_msg')
