...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarUser'
        db.create_table('calendar_user_calendaruser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('id_hash', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('is_calendar_admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('phone_number', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, blank=True)),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=150, blank=True)),
        ...
        db.send_create_signal('calendar_user', ['CalendarUser'])


    def backwards(self, orm):
        # Deleting model 'CalendarUser'
        db.delete_table('calendar_user_calendaruser')
