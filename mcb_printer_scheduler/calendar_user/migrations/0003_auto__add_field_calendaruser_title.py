...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarUser.title'
        db.add_column('calendar_user_calendaruser', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarUser.title'
        db.delete_column('calendar_user_calendaruser', 'title')
